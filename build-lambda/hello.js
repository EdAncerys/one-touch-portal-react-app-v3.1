  ...
  (function (e) {
    ...
    function (e, t, r) {
      ...
      var d = x("ERR_FR_REDIRECTION_FAILURE", ""),
        ...
        m = x("ERR_STREAM_WRITE_AFTER_END", "write after end");
      function g(e, t) {
        a.call(this),
      ...
      (g.prototype = Object.create(a.prototype)),
        (g.prototype.abort = function () {
          w(this._currentRequest), this.emit("abort");
        }),
    ...
    function (e, t, r) {
      ...
      async function s(e, t) {
        try {
          const e = (
            await o.a.get("https://icanhazdadjoke.com", {
              headers: { Accept: "application/json" },
            })
          ).data;
          return { statusCode: 200, body: JSON.stringify({ msg: e.joke }) };
        } catch (e) {
          return (
            console.log(e),
      ...
      e.exports = function (e) {
        return new Promise(function (t, r) {
          ...
          if (
            (b["User-Agent"] ||
              b["user-agent"] ||
              (b["User-Agent"] = "axios/" + l.version),
            C && !n.isStream(C))
          ) {
            if (Buffer.isBuffer(C));
            else if (n.isArrayBuffer(C)) C = Buffer.from(new Uint8Array(C));
            else {
              if (!n.isString(C))
                return v(
                  h(
          ...
          var O = g.test(R),
            ...
            j = {
              path: i(_.path, e.params, e.paramsSerializer).replace(/^\?/, ""),
          ...
          e.socketPath
            ...
            : ((j.hostname = _.hostname), (j.port = _.port));
          var A,
            T = e.proxy;
          if (!T && !1 !== T) {
            var k = R.slice(0, -1) + "_proxy",
            ...
            if (B) {
                ...
                q = !L.split(",")
                  ...
                  .some(function (e) {
                    return (
                      ...
                      ("*" === e ||
                        ("." === e[0] &&
                          _.hostname.substr(_.hostname.length - e.length) ===
                            e) ||
                        _.hostname === e)
                    );
                  });
              if (
                q &&
                ((T = { host: S.hostname, port: S.port, protocol: S.protocol }),
                S.auth)
              ) {
                var N = S.auth.split(":");
          ...
          T &&
            ((j.headers.host = _.hostname + (_.port ? ":" + _.port : "")),
            (function e(t, r, n) {
              if (
                ((t.hostname = r.host),
                (t.host = r.host),
              ...
              j,
              T,
              R + "//" + _.hostname + (_.port ? ":" + _.port : "") + j.path
            ));
          var U = O && (!T || g.test(T.protocol));
          e.transport
            ? (A = e.transport)
            : 0 === e.maxRedirects
            ? (A = U ? u : a)
            : (e.maxRedirects && (j.maxRedirects = e.maxRedirects),
              (A = U ? f : c)),
            e.maxBodyLength > -1 && (j.maxBodyLength = e.maxBodyLength);
          var P = A.request(j, function (t) {
            if (!P.aborted) {
              var r = t,
                s = t.req || P;
              if (
          ...
          P.on("error", function (t) {
            (P.aborted && "ERR_FR_TOO_MANY_REDIRECTS" !== t.code) ||
              v(m(t, e, null, P));
          }),
            e.timeout &&
              P.setTimeout(e.timeout, function () {
                P.abort(),
                  v(
                    h(
